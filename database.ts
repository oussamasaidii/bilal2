...
export const uri =
  "mongodb+srv://TiltedTowers:TiltedTowersBOM@cluster0.iwefcqe.mongodb.net/";
export const client = new MongoClient(uri);

export const usersCollection: Collection<User> = client
  .db("users")
  .collection<User>("usersCollection");
export const charactersCollection: Collection<Datum2> = client
  .db("characters")
  .collection<Datum2>("charactersCollection");
